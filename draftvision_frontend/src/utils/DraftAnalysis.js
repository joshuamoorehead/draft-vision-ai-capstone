 ...
 * Currently uses draft ID as seed but could be replaced with real analysis
 * 
...
export const generateDraftScore = (draft) => {
    ...
    // Use the draft's id as a seed for consistent scoring
    let seed;
    ...
    // Create a pseudo-random but deterministic score based on seed
    // Using a simple algorithm to distribute scores across the range
    const baseScore = (seed % 31) * 3.1 + 5; // Base range approximately 5-100
    
    // Add some variation based on other parts of the ID
